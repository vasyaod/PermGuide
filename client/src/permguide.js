...
PermGid.TouchSupport = {
     ...
     */
    init: function() {
    	document.addEventListener("touchstart",  PermGid.TouchSupport.touchHandler, false);
    	document.addEventListener("touchmove",   PermGid.TouchSupport.touchHandler, false);
    	document.addEventListener("touchend",    PermGid.TouchSupport.touchHandler, false);
    	document.addEventListener("touchcancel", PermGid.TouchSupport.touchHandler, false);    
    }
}
